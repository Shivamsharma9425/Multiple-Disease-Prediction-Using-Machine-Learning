...
#sidebar to navigate
with st.sidebar:
    selected = option_menu(" Multiple Disease Prediction System", ['Heart Disease Prediction', 'Diabetes Prediction', 'Parkinsons Disease Prediction'], icons = ['activity', 'heart', 'person'],default_index =0)
...
if selected == "Parkinsons Disease Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        ...
        parkinsons_prediction = parkinsson_model.predict([user_input])
